...
// Element references
const tournamentList = document.getElementById("tournamentList") as HTMLUListElement;
const createTournamentForm = document.getElementById("createTournamentForm") as HTMLFormElement;
const tournamentNameInput = document.getElementById("tournamentName") as HTMLInputElement;

const selectedTitle = document.getElementById("selectedTournamentTitle") as HTMLElement;
